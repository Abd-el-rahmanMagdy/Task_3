...
export default function AllPerks() {
  ...
  // Build unique merchants list whenever perks change
  useEffect(() => {
  ...
  // Auto-search with debounce whenever searchQuery or merchantFilter changes
  useEffect(() => {
    // Skip the first run to avoid duplicating the initial load
  ...
  function handleReset() {
    setSearchQuery('')
    setMerchantFilter('')
    // Immediately reload after reset for instant feedback
    loadAllPerks()
  }
